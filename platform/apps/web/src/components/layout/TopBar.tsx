      ...
      <div className="flex items-center h-[74px] px-4 justify-between gap-4">
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          <button
            ...
            style={{
              background: "rgba(150, 137, 204, 0.15)",
              border: "1px solid rgba(150, 137, 204, 0.3)",
            }}
          >
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#9689cc" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
