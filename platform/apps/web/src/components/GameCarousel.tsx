      ...
      >
        {CASINO_GAMES.map(game => (
          <Link
            key={game.href}
            href={game.href}
            className="group block flex-shrink-0 w-20 h-20 sm:w-24 sm:h-24 lg:w-28 lg:h-28 rounded-lg overflow-hidden border border-white/10 hover:border-purple-500/40 transition-all duration-200 hover:scale-105 hover:shadow-lg shadow-black/40"
          >
            <img
              src={game.thumb}
              alt={game.name}
