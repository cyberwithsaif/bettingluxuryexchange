...
export default function PlinkoPage() {
  ...
  return (
    <div className="bg-[#0b0c12] text-white flex flex-col md:flex-row min-h-screen md:min-h-0 md:h-[calc(100vh-74px)] md:overflow-hidden">
        ...
        <div className="hidden md:flex w-[260px] shrink-0 p-3 flex-col">
          {(stats.wins + stats.losses) > 0 && (
            <div className="rounded-2xl bg-[#10121e] border border-white/[0.07] overflow-hidden shadow-2xl">
              ...
              <div className="pt-1">
                <MiniChart history={stats.history} h={170} />
              </div>
            </div>
          )}
        </div>
