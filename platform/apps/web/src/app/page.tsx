  ...
  return (
    <section>
      ...
      <div
        ...
        className="flex gap-2 md:gap-3 overflow-x-auto scroll-smooth [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]"
      >
        {CASINO_GAMES.map(game => (
          <Link key={game.href} href={game.href} className="group block flex-shrink-0 w-[calc(25%-6px)] sm:w-[calc(20%-6px)] lg:w-[calc(14.28%-9px)]">
